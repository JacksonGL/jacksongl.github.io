/* this is the faulty implementation */
// code copied from http://www.nczonline.net/blog/2009/04/21/computer-science-in-javascript-doubly-linked-lists/
// the original implementation does not contain bug, 
// bug is seeded afterwards to test the effectiveness 
// of this bug localization framework.
    ...
    remove : function (index) {
        ...
        if (index > -1 && index < this._length) {
            ...
            if (index === 0) {
                ...
                current = this._tail;
                // seeded bug, correct statement: this._tail = current.prev;
                this._tail = current;
